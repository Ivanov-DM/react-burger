...
export const connectProfileOrders = createAction<string, typeof PROFILE_ORDERS_CONNECT>(PROFILE_ORDERS_CONNECT);
export const disconnectProfileOrders = createAction(PROFILE_ORDERS_DISCONNECT);
export const wsConnectingProfileOrders = createAction(PROFILE_ORDERS_WS_CONNECTING);
...
export const wsMessageProfileOrders = createAction<TGetOrdersResponse, typeof PROFILE_ORDERS_WS_MESSAGE>(PROFILE_ORDERS_WS_MESSAGE);
export const wsErrorProfileOrders = createAction<string, typeof PROFILE_ORDERS_WS_ERROR>(PROFILE_ORDERS_WS_ERROR);
