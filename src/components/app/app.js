...
export default function App() {
    ...
    const [modalWithIngredientDetailsVisible, setModalWithIngredientDetailsVisible] = React.useState(false);
    const [modalWithOrderDetailsVisible, setModalWithOrderDetailsVisible] = React.useState(false);
